...
<div class="container text-center" style="overflow-x:auto;">
			...
			<div class="registracija">
				...
				<button class="dugme" type="submit" onClick="proveri()">Registracija</button>
			...
			error_reporting(E_ALL ^ E_DEPRECATED);
				if(array_key_exists('registracija', $_POST)){
					...
					$mejl = $_POST['rmail'];
					$svepotrebno = $ime_prezime!="" && $username!="" && $lozinka!="" && $provera!="" && $clanskibroj!="" && $mejl!="" ;
					...
					$niz=mysql_fetch_array($rez);					
						...
						if(!$niz){
							...
							mysql_select_db("vk_diplomski");
							$uspeh = mysql_query("INSERT INTO korisnik (ID,ime_prezime, korisnicko_ime, lozinka, broj_telefona, 
							e-mail_adresa, clanski_broj, vrsta_korisnika, status)".
							"VALUES (NULL,'$_POST[rimeprezime]','$_POST[rkime]','$_POST[rlozinka]','$_POST[rbrtelefona]',
							'$_POST[rmail]','$_POST[rclbroj]',2,'clan')");
